...
<?php $post_object = get_field('team_leader_set');
    ...
    <div id="team-leader">
     <?php $post_id = get_the_ID(); ?>
        ...
        <h2 class="center col-right-leader team-location-title"><?php echo $location_name; ?> TEAM LEADER</h2>
        <p class="center">
...
<?php wp_reset_postdata(); endif; ?>
    ...
    <div id="testimonials">
        ...
        <?php $my_query = new WP_Query('post_type=quote&areas=corp-testimonies');while ($my_query->have_posts()) : $my_query->the_post(); $do_not_duplicate = $post->ID; ?>
            <blockquote>
    ...
    <p class="left" style="width: 150px;">A charitable, non-profit organization that provides time, talent, and treasure to further the well-being of Washington’s foster children.</p>
