<?php
    /*
     * Template Name: Eastern Washington
     */
?>
<?php get_header(); ?>
...
<?php 
$args =array(
    'post_type' => 'team_member','team_locations'=>'location-eastern-washington',
    'meta_query' => array( 
        array(
            'key' => 'team-leader', 
            'value' => '"YES"',
 ...
 ?>
     ...
     <h2 class="team-leader-m">EASTERN WASHINGTON TEAM LEADER</h2>     <div class="clear"></div>  
    <?php //Start of Loop
...
";
    ...
    <?php endwhile; ?>
                ...
                <div class="clear"></div>
                <h2>EASTERN WASHINGTON TEAM MEMBERS</h2>
<?php //Start of Loop
