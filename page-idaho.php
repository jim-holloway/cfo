...
<?php 
$args =array(
    'post_type' => 'team_member','team_locations'=>'location-idaho',
    'meta_query' => array( 
        array(
            'key' => 'team-leader', 
            'value' => '"YES"',
 ...
 ?>
     ...
     <h2 class="team-leader-m">IDAHO TEAM LEADER</h2>     <div class="clear"></div>  
    <?php //Start of Loop
